...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Project31.0.0/ && $(COPY_FILE) --parents calculator.h .tmp/Project31.0.0/ && $(COPY_FILE) --parents calculator.cpp main.cpp .tmp/Project31.0.0/ && (cd `dirname .tmp/Project31.0.0` && $(TAR) Project31.0.0.tar Project31.0.0 && $(COMPRESS) Project31.0.0.tar) && $(MOVE) `dirname .tmp/Project31.0.0`/Project31.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Project31.0.0
...
moc_calculator.cpp: /usr/include/qt5/QtWidgets/QMainWindow \
